...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *_3dMapItem = [[UIBarButtonItem alloc] initWithTitle:@"3D地图"
                                                                   style:UIBarButtonItemStyleBordered
                                                                  target:self
                                                                  action:@selector(on3dMap:)];
    self.navigationItem.rightBarButtonItem = _3dMapItem;
...
- (void)on3dMap:(id)sender
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://itunes.apple.com/cn/app/zhe-jiang-da-xue/id535733534?mt=8"]];
}
...
- (void)startLoadMapInBackground:(NSString *)path
{
    ...
    [self performSelectorOnMainThread:@selector(loadMapImage:)
                           withObject:path
                        waitUntilDone:NO];
}
...
{
    NSDictionary *boxURL = @{
        @"yq": @"http://www.izju.org/download/maps/yq.map",     // @"https://174.129.13.72/u/46239535/yq.map",
        @"zjg": @"http://www.izju.org/download/maps/zjg.map"    // @"https://174.129.13.72/u/46239535/zjg.map"
    };
