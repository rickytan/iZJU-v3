...
@interface ZJUInfoViewController ()
{
...
@implementation ZJUInfoViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.selectedTitleColor = [UIColor colorWithWhite:124.0/255
                                                    alpha:1.0];
        UIImageView *img = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"catearrow.png"]];
        img.contentMode = UIViewContentModeBottom;
        self.titleIndicatorView = img;
...
- (void)loadView
{
    ...
    UIImageView *shadow = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"cellseperator.png"]];
    shadow.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleTopMargin;
    CGRect rect = shadow.bounds;
    rect.origin.y = self.titleView.bounds.size.height - rect.size.height;
    shadow.frame = rect;
    [self.titleView addSubview:shadow];
    [shadow release];
