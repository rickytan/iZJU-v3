...
// 下面的接口是可选的
// 设置标签和(或)别名（若参数为nil，则忽略；若是空对象，则清空；详情请参考文档：http://docs.jpush.cn/pages/viewpage.action?pageId=557241）
+ (void)setTags:(NSSet *)tags alias:(NSString *)alias DEPRECATED_ATTRIBUTE;
+ (void)setTags:(NSSet *)tags alias:(NSString *)alias callbackSelector:(SEL)cbSelector object:(id)anObject;
+ (void)setTags:(NSSet *)tags callbackSelector:(SEL)cbSelector object:(id)anObject;
+ (void)setAlias:(NSString *)alias callbackSelector:(SEL)cbSelector object:(id)anObject;
